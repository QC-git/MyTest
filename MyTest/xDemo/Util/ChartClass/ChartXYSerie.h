...
//add by 尘中远
	//获取所有的x值
	//返回获得的x值个数，错误返回0
	unsigned GetAllXPointValue(double* pXValue,unsigned nLength);
	//获取所有的y值
	//返回获得的y值个数，错误返回0
	unsigned GetAllYPointValue(double* pYValue,unsigned nLength);
	//获取所有的x，y值
	//返回获得的x，y值个数，错误返回0
	unsigned GetAllXYPointValue(double* pXValue,double* pYValue,unsigned nLength);
//获取所有数据
//////////////////////////////////////////////////////////////////////////
