...
// API header(s)
	...
	typedef EHANDLEFUNC DBERRHANDLE_PROC;
	typedef MHANDLEFUNC DBMSGHANDLE_PROC;
	typedef const BYTE* LPCBYTE;
	typedef BYTE* LPBYTE;
	typedef const DBINT* LPCDBINT;
	typedef DBINT* LPDBINT;
	typedef DBCOL* LPDBCOL;
	typedef DBCURSOR* PDBCURSOR;
	typedef PDBCURSOR PDBHANDLE;
	typedef DBDATEREC* LPDBDATEREC;
	typedef DBDATETIME* LPDBDATETIME;
	typedef const DBDATETIME* LPCDBDATETIME;
	typedef void* LPVOID;
	typedef const DBBINARY* LPCDBBINARY;
	// not implemented yet
	typedef void* LPDBPROCINFO;
	typedef void* LPDBCURSORINFO;
#ifndef EXINFO
	#define EXINFO          1
#endif
		// Data Type Tokens
...
#ifndef DBSETSECURE
	#define DBSETSECURE DBSETUSER
#endif
#ifndef NO_MORE_RPC_RESULTS
